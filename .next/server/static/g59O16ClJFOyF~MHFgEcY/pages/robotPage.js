...
module.exports = __webpack_require__("zTzw");
...
// CONCATENATED MODULE: ./pages/robotPage.js
...
var robotPage_RobotPage = function RobotPage(props) {
  ...
  }), external_react_default.a.createElement("div", null, external_react_default.a.createElement("h2", null, props.data.name), external_react_default.a.createElement("p", null, props.data.email))), external_react_default.a.createElement(link_default.a, {
    href: "/"
  }, external_react_default.a.createElement("button", null, "Home")));
};

robotPage_RobotPage.getInitialProps =
/*#__PURE__*/
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            query = _ref.query;
            _context.next = 3;
            return external_isomorphic_unfetch_default()("https://jsonplaceholder.typicode.com/users/".concat(query.id));
...
/* harmony default export */ var robotPage = __webpack_exports__["default"] = (robotPage_RobotPage);
