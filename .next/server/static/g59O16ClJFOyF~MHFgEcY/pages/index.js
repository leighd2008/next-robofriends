...
var Card = function Card(_ref) {
  ...
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, name), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, email)))));
};
...
// EXTERNAL MODULE: ./node_modules/tachyons/css/tachyons.css
var tachyons = __webpack_require__("2hOx");
...
var actions_setSearchField = function setSearchField(text) {
  return {
    type: CHANGE_SEARCHFIELD,
    payload: text
  };
};
var actions_requestRobots = function requestRobots() {
...
var CardList_CardList = function CardList(_ref) {
  ...
  return external_react_default.a.createElement("div", null, robots.map(function (user, i) {
    return external_react_default.a.createElement(Card["a" /* default */], {
      key: i,
      id: user.id,
      name: user.name,
      email: user.email
...
// CONCATENATED MODULE: ./components/ErrorBoundry.js
...
var ErrorBoundry_ErrorBoundary =
/*#__PURE__*/
function (_Component) {
...
/* harmony default export */ var ErrorBoundry = (ErrorBoundry_ErrorBoundary);
...
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(MainPage, _Component);
  ...
  function MainPage() {
    ...
    _this = Object(possibleConstructorReturn["a" /* default */])(this, (_getPrototypeOf2 = Object(getPrototypeOf["a" /* default */])(MainPage)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(Object(assertThisInitialized["a" /* default */])(_this), "filterRobots", function () {
  ...
  Object(createClass["a" /* default */])(MainPage, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("div", {
        className: "tc"
      }, external_react_default.a.createElement(Header["a" /* default */], null), external_react_default.a.createElement(components_SearchBox, {
        searchChange: onSearchChange
      }), external_react_default.a.createElement(components_Scroll, null, isPending ? external_react_default.a.createElement("h1", null, "Loading") : external_react_default.a.createElement(ErrorBoundry, null, external_react_default.a.createElement(components_CardList, {
...
// EXTERNAL MODULE: ./containers/App.css
var containers_App = __webpack_require__("qWrI");
...
var App_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    onSearchChange: function onSearchChange(event) {
      return dispatch(actions_setSearchField(event.target.value));
    },
    onRequestRobots: function onRequestRobots() {
      return dispatch(actions_requestRobots());
    }
  };
};
...
function (_Component) {
  ...
  Object(createClass["a" /* default */])(App, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement(components_MainPage, this.props);
    }
  }]);
...
/* harmony default export */ var containers_App_0 = (Object(external_react_redux_["connect"])(mapStateToProps, App_mapDispatchToProps)(App_App));
// CONCATENATED MODULE: ./registerServiceWorker.js
...
var reducers_searchRobots = function searchRobots() {
...
var reducers_requestRobots = function requestRobots() {
...
var rootReducers = Object(external_redux_["combineReducers"])({
  requestRobots: reducers_requestRobots,
  searchRobots: reducers_searchRobots
});
var store = Object(external_redux_["createStore"])(rootReducers, Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a, logger));

var pages_Index = function Index() {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(external_react_redux_["Provider"], {
    store: store
  }, external_react_default.a.createElement(containers_App_0, null)), ",");
};
...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(Header, [{
    ...
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("h1", {
        className: "f1"
      }, "RoboFriends"));
    }
  }]);
